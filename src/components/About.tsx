    ...
    <section id="sobre" className="bg-slate-50 py-24" aria-labelledby="about-heading">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 id="about-heading" className="mt-3 text-3xl font-bold tracking-tight text-charcoal sm:text-4xl">
          ...
          <dl className="mt-10 grid grid-cols-3 gap-6 border-t border-slate-200 pt-8">
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <dd className="text-2xl font-bold text-charcoal">{stat.value}</dd>
        ...
        <div
          className="flex aspect-[4/3] items-center justify-center rounded-2xl bg-gradient-to-br from-charcoal-dark via-charcoal to-charcoal-dark p-12"
          role="img"
          aria-label="Logótipo da Carmona & Pinto - Imobiliário e Construção"
        >
          <Image
            src="/logo-white.png"
            alt="Carmona & Pinto - Imobiliário e Construção"
            width={1193}
            height={685}
