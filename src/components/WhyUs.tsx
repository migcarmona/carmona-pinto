    ...
    <section className="bg-white py-24" aria-labelledby="whyus-heading">
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-2xl">
          ...
          <h2 id="whyus-heading" className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
        ...
        <div className="mt-14 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2">
          {reasons.map((reason, index) => (
            <div key={reason.title} className="flex gap-5">
              <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-900 text-sm font-bold text-brand-400">
