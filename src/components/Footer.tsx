      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-6 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><a href="#servicos" className="hover:text-amber-400">Serviços</a></li>
            <li><a href="#sobre" className="hover:text-amber-400">Sobre Nós</a></li>
            <li><a href="#processo" className="hover:text-amber-400">Como Funciona</a></li>
            <li><a href="#contactos" className="hover:text-amber-400">Contactos</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {phones.map((phone) => (
              <li key={phone.href}>
                <a href={phone.href} className="hover:text-amber-400">{phone.display}</a>
              </li>
            ))}
            <li><a href={`mailto:${email}`} className="hover:text-amber-400">{email}</a></li>
            <li>{address.full}</li>
          </ul>
        </div>
      </div>
